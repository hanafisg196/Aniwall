...
class CategoriesDataResource(
...
):PagingSource<Int, Categories> () {
    override fun getRefreshKey(state: PagingState<Int, Categories>): Int? {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Categories> {
        return try {
